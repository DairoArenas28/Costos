...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
	...
	public TextPrompt(String text, JTextComponent component, Color primary) {
		this(text, component, Show.ALWAYS, primary);
	}

	public TextPrompt(String text, JTextComponent component, Show show, Color primary) {
